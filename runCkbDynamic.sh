# Usage: ./ckbDynamicNodeSet numberOfNodes minCommunitySize maxCommunitySize minCommunityMembership maxCommunityMembership eventProbability intraCommunityEdgeProbability epsilon
./ckbDynamicNodeSet 1000 10 100 1 100 0.1 2 2
...
#	communityId - 	community Id in which edge was generated. When intra-community edge (u,v) is generated, the edge (v,u) is inserted as a reverse edge
#			with community Id -1 since this is an undirected graph. When an epsilon edge (u,v) is generated, its community Id is -2, and the
#			corresponding reverse edge has community Id -4.
